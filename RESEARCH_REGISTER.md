...
| R-04 | Wie kann knappe intensivmedizinische Ressourcenzuteilung erzählt werden, ohne „Menschenwert-Score“ oder vereinfachte Triageethik? | Cold Open; Laura; Finale | high | resolved | DIVI-Sektion Ethik: verantwortungsvoller Umgang mit intensivmedizinischen Ressourcen, individuelle Therapieziele, interdisziplinäre/interprofessionelle Entscheidungsfindung. BVerfG Triage II zeigt zugleich die besondere grundrechtliche Sensibilität fachlicher Allokationsregeln. | KORA bewertet keinen sozialen Wert. Es schätzt zeitkritischen klinischen Nutzen, Verzögerungsrisiko und Ressourcenfolgen unter menschlich gesetzter klinischer Policy. Patientenwille/Therapieziel bleiben eigenständige menschliche Dimensionen. | no |
...
| R-06 | Welche konkreten Diagnosen, Zeitfenster, Intensivressourcen und Behandlungsfolgen eignen sich für Cold Open, Nele-Schaden, Felix-Schaden und Finale medizinisch plausibel? | Beats; Szenenkarten; Prosa | high | open | noch nicht erhoben; soll gezielt mit Fachquellen/Fachleitlinien erfolgen, sobald die konkreten Szenen geplant werden | G1 bleibt bewusst auf Entscheidungstyp/Ressourcenkonflikt. Vor G2 müssen die medizinischen Schlüsselereignisse konkretisiert und plausibilisiert werden. | no |
...
Status `open`, aber `blocking_now: no` für G1.

Begründung: Die G1-Architektur benötigt noch keine spezifische Diagnose oder konkrete Intensivtechnik. Sobald Beats/Szenen einen medizinischen Verlauf festlegen, wird R-06 vor dieser Entscheidung zu `blocking_now: yes` und erst nach belastbarer Recherche wieder geschlossen.
...
- R-06 muss spätestens vor der ersten medizinisch konkreten G2-Szenenentscheidung geschlossen werden.
